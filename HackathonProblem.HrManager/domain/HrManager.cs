...
namespace HackathonProblem.HrManager.domain;

public class HrManager(IHrDirector director) : IHrManager
{
        ...
        IEnumerable<Wishlist> teamLeadsWishlists, IEnumerable<Wishlist> juniorsWishlists)
    {
        ...
        var harmonization2 =
            director.CalculateTeamsHarmonization(result2, teamLeadsWishlistsList, juniorsWishlistsList);
        ...
        IEnumerable<Wishlist> sendersWishlists, IEnumerable<Wishlist> receiversWishlists)
    {
        ...
        while (areOffersPossible)
        {
            ...
            for (var senderIndex = 0; senderIndex < count; senderIndex++)
            {
                ...
                var currentHarmonization = director.CalculateEmployeeHarmonization(desiredSenders, chosenSenderId);
                var potentialHarmonization = director.CalculateEmployeeHarmonization(desiredSenders, potentialSenderId);
