...
namespace HackathonProblem.Db.Migrations
{
    ...
    [Migration("20241106133109_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.HackathonEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.JuniorEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.JuniorPreferenceEntity", b =>
                {
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.TeamEntity", b =>
                {
                    b.Property<int>("HackathonId")
                        .HasColumnType("integer")
                        .HasColumnName("hackathon_id");
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.TeamLeadEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.TeamLeadPreferenceEntity", b =>
                {
                    b.Property<int>("HackathonId")
                        .HasColumnType("integer")
                        .HasColumnName("hackathon_id");
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.JuniorPreferenceEntity", b =>
                {
                    b.HasOne("HackathonProblem.Db.entities.TeamLeadEntity", "DesiredTeamLead")
                        .WithMany()
                    ...
                    b.HasOne("HackathonProblem.Db.entities.HackathonEntity", "Hackathon")
                        .WithMany()
                    ...
                    b.HasOne("HackathonProblem.Db.entities.JuniorEntity", "Junior")
                        .WithMany()
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.TeamEntity", b =>
                {
                    ...
                    b.HasOne("HackathonProblem.Db.entities.TeamLeadEntity", "TeamLead")
                        .WithMany()
            ...
            modelBuilder.Entity("HackathonProblem.Db.entities.TeamLeadPreferenceEntity", b =>
                {
                    b.HasOne("HackathonProblem.Db.entities.JuniorEntity", "DesiredJunior")
                        .WithMany()
